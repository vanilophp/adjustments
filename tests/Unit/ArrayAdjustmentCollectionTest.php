...
class ArrayAdjustmentCollectionTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(AdjustmentCollectionContract::class, new ArrayAdjustmentCollection());
    }

    /** @test */
    public function it_is_empty_by_default()
    {
        $c = new ArrayAdjustmentCollection();
    ...
    public function items_can_be_filtered_by_type()
    {
        ...
        $this->assertInstanceOf(AdjustmentCollectionContract::class, $promotions);
        $this->assertCount(3, $promotions);

        $taxes = $c->byType(AdjustmentType::TAX());
        $this->assertInstanceOf(AdjustmentCollectionContract::class, $taxes);
        $this->assertCount(2, $taxes);

        $shippingFees = $c->byType(AdjustmentType::SHIPPING());
        $this->assertInstanceOf(AdjustmentCollectionContract::class, $shippingFees);
